...
const cvPage = () => (
  ...
  <li><b>I led the product and design teams at UserVoice,</b> the leader in product feedback management used by MSFT, Adobe, Google, Box, Cisco, etc. I oversaw the evolution of the product by enriching customer data and adding subsequent data analysis and segmentation capabilities. This was key for aggregating and translating huge amounts of qualitative data into actionable realtime product insights that are a real competitive advantage. Further integrations captured indirect feedback data from customer facing teams (support, sales, success, etc) providing 360 degree coverage. Working with the other leaders we more than doubled ARR and more than tripled ASP during my tenure.</li>
  <li>During my time at Electronic Arts I wore various hats while we grew the small studio EA2D from 6 to ~40 people. Eventually I oversaw the integration into acclaimed BioWare as the interim Studio Manager with 35 direct and indirect reports. Among other things I led the technology team that created the platform that enabled EA to become a launch partner for Google's google+ gaming platform (This was exciting work even if ultimately doomed).</li>
